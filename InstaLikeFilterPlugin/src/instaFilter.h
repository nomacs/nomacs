...
class instaFilter : public QObject, DkPluginInterface {
	Q_OBJECT
	Q_INTERFACES(nmc::DkPluginInterface)
	Q_PLUGIN_METADATA(IID "com.nomacs.ImageLounge.instaFilter/3.0" FILE "instaFilter.json")

public:

	instaFilter(QObject* parent = 0);
	~instaFilter();
	...
	static QImage xProFilter(QImage imgInput);
	enum {
		ID_ACTION1,
		// add actions here
