...
class DkMarsPlugin : public QObject, DkPluginInterface {
    Q_OBJECT
    Q_INTERFACES(nmc::DkPluginInterface)
    Q_PLUGIN_METADATA(IID "com.nomacs.ImageLounge.DkMarsPlugin/3.0" FILE "DkMarsPlugin.json")

public:

    DkMarsPlugin(QObject* parent = 0);
    ~DkMarsPlugin();
