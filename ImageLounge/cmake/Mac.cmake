...
if(ENABLE_QUAZIP)
	if(USE_SYSTEM_QUAZIP)
		...
		message(STATUS "QUAZIP: using 3rd-party/quazip")
		find_package(ZLIB REQUIRED QUIET)
		find_package(BZip2 REQUIRED QUIET)
		set(QUAZIP_SOURCE_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/../3rd-party/quazip/quazip)
		set(QUAZIP_LIBRARIES ZLIB::ZLIB)
		if(QT_VERSION_MAJOR GREATER 5)
			find_package(Qt${QT_VERSION_MAJOR} REQUIRED COMPONENTS Core5Compat)
			set(QUAZIP_LIBRARIES ${QUAZIP_LIBRARIES} Qt::Core5Compat)
		endif()
		file(GLOB QUAZIP_SOURCES "${QUAZIP_SOURCE_DIRECTORY}/*.c" "${QUAZIP_SOURCE_DIRECTORY}/*.cpp")
		file(GLOB QUAZIP_HEADERS "${QUAZIP_SOURCE_DIRECTORY}/*.h")
		add_definitions(-DWITH_QUAZIP)
		add_definitions(-DWITH_QUAZIP1)
