...
target_link_libraries(${DLL_NAME} ${QT_QTCORE_LIBRARY} ${QT_QTGUI_LIBRARY} ${QT_QTNETWORK_LIBRARY} ${QT_QTMAIN_LIBRARY} ${EXIV2_LIBRARIES} ${LIBRAW_LIBRARIES} ${OpenCV_LIBS} ${VERSION_LIB} ${TIFF_LIBRARIES} ${HUPNP_LIBS} ${HUPNPAV_LIBS} ${QUAZIP_DEPENDENCY})
add_dependencies(${BINARY_NAME} ${DLL_NAME} ${QUAZIP_DEPENDENCY}) #QUAZIP_DEPENDENCY is empty when quazip is disabled
...
source_group("Generated Files" FILES ${NOMACS_MOC_SRC} ${LIBQPSD_MOCS_SRC} ${NOMACS_RCC} ${NOMACS_UI} ${NOMACS_RC} ${NOMACS_QM} ${NOMACS_AUTOMOC})
