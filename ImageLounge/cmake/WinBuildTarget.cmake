...
if (ENABLE_INCREMENTER)
    add_custom_command(TARGET ${DLL_CORE_NAME} PRE_BUILD COMMAND python ${CMAKE_CURRENT_SOURCE_DIR}/version-incrementer.py ${CMAKE_CURRENT_SOURCE_DIR}/src/DkCore/DkVersion.h)
