...
add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:qpsd> ${NOMACS_BUILD_DIRECTORY}/$<CONFIGURATION>/)
IF (NOT ENABLE_QT5)
...
if(ENABLE_WEBP)
	...
	add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:webp> ${NOMACS_BUILD_DIRECTORY}/$<CONFIGURATION>/)
