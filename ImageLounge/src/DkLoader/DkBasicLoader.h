...
#else
	bool saveWindowsIcon(const QString& filePath, const QImage& mImg) const { return false; };
	bool saveWindowsIcon(const QImage& mImg, QSharedPointer<QByteArray>& ba) const { return false; };
#endif
