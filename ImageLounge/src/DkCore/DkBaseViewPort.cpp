    ...
    : QGraphicsView(parent)
{
    ...
    DkShortcutEventFilter::reserveKeys(
        this,
        {DkActionManager::shortcut_zoom_in, DkActionManager::shortcut_zoom_out, DkActionManager::shortcut_zoom_in_alt, DkActionManager::shortcut_zoom_out_alt});
