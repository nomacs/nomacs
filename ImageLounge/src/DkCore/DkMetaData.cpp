...
bool DkMetaDataT::isTiff() const
{
    ...
    return newSuffix.contains(QRegularExpression("(tif|tiff)",
...
{
    QString newSuffix = QFileInfo(mFilePath).suffix();
    return newSuffix.contains(QRegularExpression("(jpg|jpeg)",
                                QRegularExpression::CaseInsensitiveOption)) != 0;
}
...
{
    QString newSuffix = QFileInfo(mFilePath).suffix();
    return newSuffix.contains(QRegularExpression("(nef|crw|cr2|arw)",
                                QRegularExpression::CaseInsensitiveOption)) != 0;
}
...
{
    QString newSuffix = QFileInfo(mFilePath).suffix();
    return newSuffix.contains(QRegularExpression("(avif)",
                                QRegularExpression::CaseInsensitiveOption)) != 0;
}
...
{
    QString newSuffix = QFileInfo(mFilePath).suffix();
    return newSuffix.contains(QRegularExpression("(heic|heif)",
                                QRegularExpression::CaseInsensitiveOption)) != 0;
}
...
{
    QString newSuffix = QFileInfo(mFilePath).suffix();
    return newSuffix.contains(QRegularExpression("(jxl)",
                                QRegularExpression::CaseInsensitiveOption)) != 0;
}
