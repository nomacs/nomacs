...
To change version that will appear in builds:
- In `ImageLounge/CMakeLists.txt` change `NOMACS_VERSION_*`.
- Change `scripts/utils/version.cache` to match.

Everything else should update automatically when re-running cmake.
