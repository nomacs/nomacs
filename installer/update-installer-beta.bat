...
C:\Qt\QtIFW2.0.1\bin\binarycreator.exe -n -c config-beta\config.xml -p packages -r config/resources.qrc nomacs-setup-beta

"C:\Program Files (x86)\Windows Kits\10\bin\x64\signtool" sign /f C:\VSProjects\TU-code-signing.p12  /t http://timestamp.digicert.com nomacs-setup-beta.exe
