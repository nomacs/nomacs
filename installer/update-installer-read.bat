...
D:\Qt\QtIFW2.0.5\bin\binarycreator.exe -c config-read\config-offline.xml -p packages -r config/resources.qrc cvl-read-setup-offline

REM use for final online installer
D:\Qt\QtIFW2.0.5\bin\binarycreator.exe -n -c config-read\config.xml -p packages -r config/resources.qrc cvl-read-setup
